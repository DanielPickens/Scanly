...
import (
	...
	"github.com/danielpickens/scanly/filetree"
	"github.com/danielpickens/scanly/scanly/image"
	"github.com/danielpickens/scanly/runtime/ui/view"
	"github.com/danielpickens/scanly/runtime/ui/viewmodel"
)
...
//render previous pane from status bar
...
func (c *Controller) ToggleCompareMode() error
{
	c.views.Layer.ToggleCompareMode()

	return c.onLayerChange(viewmodel.LayerSelection{
...
func (c *Controller) ToggleCompareModeAll() error 
{
	x := c.views.Layer.CompareMode()

	if x == viewmodel.CompareAllLayers {
		c.views.Layer.SetCompareMode(viewmodel.CompareTopLayer)
	} else {
		c.views.Layer.SetCompareMode(viewmodel.CompareAllLayers)
	}
